...
public abstract class Hilt_HealthStatsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HealthStatsFragment() {
    super();
  }

  Hilt_HealthStatsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HealthStatsFragment_GeneratedInjector) this.generatedComponent()).injectHealthStatsFragment(UnsafeCasts.<HealthStatsFragment>unsafeCast(this));
    }
  }
