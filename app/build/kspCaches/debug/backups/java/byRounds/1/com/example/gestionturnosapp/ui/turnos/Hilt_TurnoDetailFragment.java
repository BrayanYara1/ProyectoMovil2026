...
public abstract class Hilt_TurnoDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TurnoDetailFragment() {
    super();
  }

  Hilt_TurnoDetailFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TurnoDetailFragment_GeneratedInjector) this.generatedComponent()).injectTurnoDetailFragment(UnsafeCasts.<TurnoDetailFragment>unsafeCast(this));
    }
  }
