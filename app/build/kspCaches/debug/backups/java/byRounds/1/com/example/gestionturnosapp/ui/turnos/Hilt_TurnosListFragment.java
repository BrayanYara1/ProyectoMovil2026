...
public abstract class Hilt_TurnosListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TurnosListFragment() {
    super();
  }

  Hilt_TurnosListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TurnosListFragment_GeneratedInjector) this.generatedComponent()).injectTurnosListFragment(UnsafeCasts.<TurnosListFragment>unsafeCast(this));
    }
  }
