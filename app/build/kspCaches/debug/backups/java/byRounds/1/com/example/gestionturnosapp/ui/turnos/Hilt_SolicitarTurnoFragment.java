...
public abstract class Hilt_SolicitarTurnoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SolicitarTurnoFragment() {
    super();
  }

  Hilt_SolicitarTurnoFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SolicitarTurnoFragment_GeneratedInjector) this.generatedComponent()).injectSolicitarTurnoFragment(UnsafeCasts.<SolicitarTurnoFragment>unsafeCast(this));
    }
  }
