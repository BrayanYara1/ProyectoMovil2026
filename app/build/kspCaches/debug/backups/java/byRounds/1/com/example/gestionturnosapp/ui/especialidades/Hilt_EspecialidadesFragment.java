...
public abstract class Hilt_EspecialidadesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EspecialidadesFragment() {
    super();
  }

  Hilt_EspecialidadesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EspecialidadesFragment_GeneratedInjector) this.generatedComponent()).injectEspecialidadesFragment(UnsafeCasts.<EspecialidadesFragment>unsafeCast(this));
    }
  }
