...
public abstract class Hilt_EstudiosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EstudiosFragment() {
    super();
  }

  Hilt_EstudiosFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EstudiosFragment_GeneratedInjector) this.generatedComponent()).injectEstudiosFragment(UnsafeCasts.<EstudiosFragment>unsafeCast(this));
    }
  }
