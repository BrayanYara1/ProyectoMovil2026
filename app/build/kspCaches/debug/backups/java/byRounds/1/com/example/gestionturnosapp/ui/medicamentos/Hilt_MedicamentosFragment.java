...
public abstract class Hilt_MedicamentosFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MedicamentosFragment() {
    super();
  }

  Hilt_MedicamentosFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MedicamentosFragment_GeneratedInjector) this.generatedComponent()).injectMedicamentosFragment(UnsafeCasts.<MedicamentosFragment>unsafeCast(this));
    }
  }
