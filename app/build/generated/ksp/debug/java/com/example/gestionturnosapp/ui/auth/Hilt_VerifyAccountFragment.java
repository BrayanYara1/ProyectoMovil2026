...
public abstract class Hilt_VerifyAccountFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VerifyAccountFragment() {
    super();
  }

  Hilt_VerifyAccountFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerifyAccountFragment_GeneratedInjector) this.generatedComponent()).injectVerifyAccountFragment(UnsafeCasts.<VerifyAccountFragment>unsafeCast(this));
    }
  }
